...
(function() {
  ...
  Timezones = (function() {
    ...
    Timezones.prototype.getTimeZoneList = function() {
      return {
    ...
    Timezones.prototype.getTimeZoneMap = function() {
      return {
    ...
    Timezones.prototype.getCurrentDayAbbreviation = function(timezone) {
      return moment.tz(timezone).format('ddd').toLowerCase();
    };

    Timezones.prototype.getCurrentTime = function(timezone) {
